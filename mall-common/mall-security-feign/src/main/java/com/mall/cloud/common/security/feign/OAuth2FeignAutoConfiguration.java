...
public class OAuth2FeignAutoConfiguration {
	 ...
	 */
	@Bean("mallClientCredentialsResourceDetails")
	 ...
	 */
	@Bean
	public RequestInterceptor oauth2FeignRequestInterceptor(@Qualifier("mallOAuth2RestTemplate") OAuth2RestTemplate oAuth2RestTemplate) {
