package com.mall.cloud.provider.uac.common.base.constant;
...
public class GlobalConstant {
	...
	public static final String ROOT_PREFIX = "mall";

	public static final int EXCEPTION_CAUSE_MAX_LENGTH = 2048;
	public static final int EXCEPTION_MESSAGE_MAX_LENGTH = 2048;

	public static final String ZK_REGISTRY_SERVICE_ROOT_PATH = "/mall/registry/service";
	public static final String ZK_REGISTRY_ID_ROOT_PATH = "/mall/registry/id";
	public static final String ZK_REGISTRY_PRODUCER_ROOT_PATH = "/mall/registry/producer";
	public static final String ZK_REGISTRY_CONSUMER_ROOT_PATH = "/mall/registry/consumer";
	public static final String ZK_REGISTRY_SEQ = "/mall/seq";
	...
	public static final class Sys {
		 ...
		 */
		public static final String DEFAULT_FILE_PATH = "mall/file/";
